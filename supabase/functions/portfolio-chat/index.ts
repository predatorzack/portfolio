...
At DotPe from July 2021 to October 2022 in Gurgaon, I built Bifrost, a business-to-business SaaS platform to manage catalog and order processing for food and beverage merchants. We onboarded enterprise clients including McDonald's and Haldiram's, generating 4 million rupees in annual recurring revenue and processing 10 million lifetime orders. I also led the development of kitchen dashboards, waiter app, and catalog management which reduced table turnaround time by 20% and generated over 6 million rupees in revenue. I partnered with finance and operations for payment gateway selection, and external payment service providers to manage settlements, refunds, and reporting using SQL and Power BI, ensuring accuracy across large-scale merchant ecosystems. I also implemented data-based ranking algorithms in a last-mile aggregator platform, improving delivery metrics from 97% to 98.2%.

At Spinny from March 2019 to July 2021 as an Associate Program Manager in Gurgaon, I developed a refurbishment CRM and inspection app that increased refurbished cars per month by 10 times and reduced turnaround time by 37%. I improved inspection accuracy by incorporating image and sound processing algorithms and enhancing workflows for accurate estimation of repair costs, strengthened procurement decisions, and profit and loss outcomes. I collaborated with UX and support teams to improve user journeys based on product usage. I monitored dashboards to establish operations standardisation and cross-functional teamwork. I used SQL and Power BI to create dashboards and analytics tools that drove 15% operational cost reduction through automation and reporting streamlining.

I started my career as a Graduate Engineer Trainee at Tega Industries in Kolkata from July 2017 to January 2018, working on product model conceptualization and validation for wear-resistant mill components. I also delivered data-driven dashboards linking sales activity to client financial benefits, resulting in revenue growth for clients.

I also did internships at IIT Patna in 2016 where I worked on a comprehensive integrated diagnostic study of tora-tora ride clusters organized by the Government of Bihar, and at IIM Lucknow in 2015 where I conducted marketing research and analysis informed by insights from Harvard Business Review articles and leading industry publications.
