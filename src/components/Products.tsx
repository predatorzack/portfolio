...
import heyalphaImg from "@/assets/product-heyalpha.jpg";
import bifrostImg from "@/assets/product-bifrost.jpg";
import electricpeImg from "@/assets/product-electricpe.jpg";
import spinnyImg from "@/assets/product-spinny.jpg";
const products = [{
  company: "Alphadroid",
  ...
  return <section id="products" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-8 max-w-5xl mx-auto">
          {products.map((product, index) => <Card key={index} className={`overflow-hidden border-border hover:border-accent transition-all duration-300 bg-gradient-to-br ${product.color} animate-fade-in-up`} style={{
          ...
          opacity: 0
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="relative h-full min-h-[400px] md:min-h-0">
                  <img src={product.image} alt={`${product.title} illustration`} className="absolute inset-0 w-full h-full object-cover" /><img src={product.image} alt={`${product.title} illustration`} className="absolute inset-0 w-full h-full object-cover" />
                </div>
              </div>
            </Card>)}
        </div>
