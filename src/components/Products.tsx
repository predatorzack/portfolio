...
const products = [{
  ...
  achievements: ["Led team of 12 (devs, AI engineers, QA, design) and mentored 2 Product Analysts", "Launched 0-to-1 revenue stream, generating 5M INR in first year", "Scaled AI-driven self check-in/out and Ticketing & Routing solution for 20 hotels", "Deployed patient registration and voice navigation for 10 hospitals", "Enabled 30k+ user interactions per day across multiple industries"],
  metrics: [{
    icon: TrendingUp,
    label: "5M INR",
