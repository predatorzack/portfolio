...
const products = [{
  ...
  achievements: ["Onboarded McDonald's and Haldiram's as enterprise clients", "Generated 4M INR in ARR and Processed 10M+ lifetime orders", "Managed Payment gateway integrations for Bifrost platform", "Led development of Fine Dine Suite with kitchen dashboards and waiter app", "Reduced table turnaround time by 20%", "Improved delivery metrics from 97% to 98.2% using data-based ranking algorithms"],
  metrics: [{
    icon: TrendingUp,
    label: "4M INR",
