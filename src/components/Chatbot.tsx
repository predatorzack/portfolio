...
const Chatbot = () => {
  ...
  return <>
      ...
      <button onClick={() => setIsOpen(!isOpen)} className={`fixed bottom-6 right-6 z-50 h-24 w-24 rounded-full bg-accent hover:bg-accent/90 shadow-lg shadow-accent/25 flex items-center justify-center transition-transform hover:scale-105 overflow-hidden ${!isOpen ? 'animate-subtle-bounce' : ''}`}>
